...
ALLOWED_HOSTS = os.environ.get('ALLOWED_HOSTS', 'localhost,127.0.0.1,.pythonanywhere.com,.onrender.com,.railway.app,.koyeb.app,*').split(',')
...
MIDDLEWARE = [
    ...
    # 'StressDetection.cors_middleware.CorsMiddleware',  # Removed redundant custom middleware
